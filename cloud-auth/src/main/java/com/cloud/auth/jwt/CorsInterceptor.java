...
public class CorsInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        httpServletResponse.setHeader("Access-Control-Allow-Headers", "X-URL-PATH, Origin, X-Requested-With, X_Requested_With, Content-Type, Accept, lmt-token, user-id, openid, x-access-token, Access-Control-Allow-Origin,Set-Cookie,Cookie,userFlag,SsdsAccountId,SsdsAccessToken,SsdsClientDeviceID");
